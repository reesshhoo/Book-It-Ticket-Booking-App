                            ...
                            <form class="form">
                                ...
                                <div class="form-check">
                                    ...
                                    <span style="margin-left: 50px;">
                                        <input class="form-check-input" type="radio" name="adminradio" v-model="role"
                                ...
                                <div class="d-grid gap-2">
                                    <button @click.prevent="submitForm" class="btn btn-lg btn-primary" type="button"
                                        value="Login-admin">Log In</button>
                                </div>
                            </form>
                            <p class="mt-2">Not Registered?<router-link to="/Register"> Sign Up </router-link> </p>
                        </div>
                    </div>
                </div>
            </div>
